...
const characters = [
    { id:1, img:'../characters/character_1.png', name:'Кайтос Руст', title:'Лицар-Щит', lore:'Витягнутий з уламків цитаделі, оберігає слабких.', quote:'"Щит мій — це моя честь"', hp:88, atk:12, spd:6 },
    { id:2, img:'../characters/character_2.png', name:'Міра Страж', title:'Маг-стрілець', lore:'Колись мисливець за зорями, тепер боронить кордони.', quote:'"Зорі вказують шлях"', hp:68, atk:18, spd:7 },
    { id:3, img:'../characters/character_3.png', name:'Елла Файр', title:'Палаюча Варта', lore:'Полум\'я її серця зупиняє найтемніші вороже.', quote:'"Вогонь очищає все"', hp:72, atk:15, spd:8 },
    { id:4, img:'../characters/character_4.png', name:'Таро Блейд', title:'Острієвий Мандрівник', lore:'Несучий маску предків і таємниці старих рун.', quote:'"Маска приховує, але не змінює"', hp:92, atk:10, spd:5 },
    { id:5, img:'../characters/character_5.png', name:'Грон Вік', title:'Дуб Крила', lore:'Ветеран багатьох битв, спокійний як скеля.', quote:'"Досвід — найкращий учитель"', hp:110, atk:20, spd:3 },
    { id:6, img:'../characters/character_6.png', name:'Рейна Клир', title:'Булава Суду', lore:'Непохитний охоронник, що ставить захист понад все.', quote:'"Захист — це моя місія"', hp:86, atk:14, spd:6 },
    { id:7, img:'../characters/character_7.png', name:'Ліан Свіфт', title:'Тіньовий Розвідник', lore:'Швидкий і виверткий, що зникає та з\'являється', quote:'"Тінь завжди поруч"', hp:62, atk:11, spd:13 },
    { id:8, img:'../characters/character_8.png', name:'Зіра Арчер', title:'Лісовий Воїн', lore:'Майстер ближнього бою, чия сила та спритність стали легендою.', quote:'"Сила в русі"', hp:58, atk:17, spd:10 },
    { id:9, img:'../characters/character_9.png', name:'Том Рур', title:'Господар Селища', lore:'Звичний герой, що завжди повертається заради рідних.', quote:'"Дім — це там, де серце"', hp:76, atk:11, spd:9 },
    { id:10, img:'../characters/character_10.png', name:'Кел Він', title:'Юний Воїн', lore:'Палке серце і гострий розум роблять його небезпечним.', quote:'"Молодість — це сила"', hp:72, atk:16, spd:11 },
    { id:11, img:'../characters/character_11.png', name:'Ара Найт', title:'Нічний Рейнджер', lore:'Воїн, що бачить у темряві й карає тінь.', quote:'"Темрява — мій союзник"', hp:66, atk:13, spd:13 },
    { id:12, img:'../characters/character_12.png', name:'Енно Лорд', title:'Відважний Комендант', lore:'Командир із сталевим духом, що веде за собою.', quote:'"Відвага веде до перемоги"', hp:98, atk:14, spd:5 }
  ];
